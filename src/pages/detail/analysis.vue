<template>
  <div class="sales-board">
    ...
    <my-dialog :isShow="toggledata" @on-close="hidedialog">
      ...
      <bank-choose @on-change="getbankobj"></bank-choose>
    ...
    <check-order
      :order-id="orderId"
      :isShowCheckDialog="isShowCheckOrder"
...
import BankChoose from '../../components/bankvhooser'
...
//        return x.value
//      }
//      let buyVersionsArray = this.versions.map(pow);
